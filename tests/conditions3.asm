...
;
; Input	MD5   :	56C6E5183BEB1AC630CD727DF3A6F9B6

; File Name   :	Z:\home\thewormkill\decomp\tests\conditions3
...
db    ?	;
db    ?	;
off_8049810 dd offset printf
off_8049814 dd offset __gmon_start__
off_8049818 dd offset __libc_start_main
_got_plt ends
