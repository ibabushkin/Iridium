...
;
; Input	MD5   :	E96F4355E7EA70C73B3FF8CCC35A672E

; File Name   :	Z:\home\thewormkill\decomp\tests\conditions2
...
mov	[esp+20h+var_20], offset aLol3 ; "LOL3"
call	_printf
...
db    ?	;
db    ?	;
off_8049820 dd offset printf
off_8049824 dd offset __gmon_start__
off_8049828 dd offset __libc_start_main
_got_plt ends
