...
;
; Input	MD5   :	7A64E88B581DBA7DCC11D353EB0C1472

; File Name   :	Z:\home\thewormkill\Iridium\tests\data
...
mov	[esp+90h+var_90], offset aLolData____ ;	"Lol! DATA...."
call	_printf
leave
retn
main endp
...
db    ?	;
db    ?	;
off_8049850 dd offset printf
off_8049854 dd offset __gmon_start__
off_8049858 dd offset __libc_start_main
_got_plt ends
