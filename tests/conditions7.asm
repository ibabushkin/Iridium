...
;
; Input	MD5   :	737F41476A74C757C81EC32C20299079

; File Name   :	Z:\home\thewormkill\decomp\tests\conditions7
...
db    ?	;
db    ?	;
off_8049808 dd offset printf
off_804980C dd offset __gmon_start__
off_8049810 dd offset __libc_start_main
_got_plt ends
