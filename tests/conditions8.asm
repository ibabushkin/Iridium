...
;
; Input	MD5   :	CDC4C35051719147BCD8E7D69FE15ADF

; File Name   :	Z:\home\thewormkill\decomp\tests\conditions8
...
mov	[esp+20h+var_20], offset aLoled	; "LOLED"
call	_printf
jmp	short loc_8048553

loc_8048547:		; "LOLED again"
...
db    ?	;
db    ?	;
off_8049834 dd offset printf
off_8049838 dd offset __gmon_start__
off_804983C dd offset __libc_start_main
_got_plt ends
